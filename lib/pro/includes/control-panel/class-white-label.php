	...
	class JupiterX_Control_Panel_White_Label {
		...
		public function settings_html() {
			...
			<div class="form-group col-md-12 <?php echo ! jupiterx_get_option( 'white_label' ) ? 'hidden' : ''; ?>" data-for="jupiterx_white_label">
				<div class="alert alert-info"><?php esc_html_e( 'For further customization on theme name, slug, thumbnail and description that appears in Appearances > Themes, please create a basic child theme.', 'jupiterx-core' ); ?></div>
			</div>
			<?php
		}
	}
