...
!function(t, n, e) {
  "use strict";
  "function" == typeof define && define.amd ? define(e) : "undefined" != typeof module && module.exports ? module.exports = e() : n.PubSub = e("PubSub", n)
}(0, this, function(t, n) {
  "use strict";
  function e(t, n, e) {
      var u;
      for (u in t)
          if (Object.prototype.hasOwnProperty.call(t, u) && n && !1 === n.call(e, t[u], u, t))
              return;
      return t
  }
  function u(t) {
  ...
  function r(t, n, e) {
      for (var u, r, i = t._pubsub_topics, o = i[n] ? i[n].slice(0) : [], s = 0, c = o.length; s < c; s += 1)
          r = o[s].token,
          (u = o[s]).callback(e, {
              name: n,
              token: r
          }),
          !0 === u.once && t.unsubscribe(r)
  }
  function i(t) {
  ...
  function o(t, n, e, u) {
      return !!t._pubsub_topics[n] && (u ? r(t, n, e) : setTimeout(function() {
          r(t, n, e)
      }, 0),
      !0)
  }
  ...
  var c = (n || {})[t];
  return s.prototype.subscribe = function(t, n, e) {
      var u = this._pubsub_topics
        , r = this._pubsub_uid += 1
        , i = {};
  ...
  ,
  s.prototype.subscribeOnce = function(t, n) {
      return this.subscribe(t, n, !0)
  }
  ,
  s.prototype.publish = function(t) {
      return o(this, t, i(arguments), !1)
  }
  ,
  s.prototype.publishSync = function(t) {
      return o(this, t, i(arguments), !0)
  }
  ,
  s.prototype.unsubscribe = function(t) {
      var n, e, u = this._pubsub_topics, r = !1;
      for (n in u)
          if (Object.prototype.hasOwnProperty.call(u, n) && u[n]) {
              for (e = u[n].length; e; ) {
                  if (e -= 1,
                  u[n][e].token === t)
                      return u[n].splice(e, 1),
                      0 === u[n].length && delete u[n],
                      t;
                  n === t && (u[n].splice(e, 1),
                  0 === u[n].length && delete u[n],
                  r = !0)
  ...
  ,
  s.prototype.hasSubscribers = function(t) {
      var n = this._pubsub_topics
        , u = !1;
      return null == t ? (e(n, function(t, n) {
          if (n)
              return u = !0,
              !1
      }),
      u) : Object.prototype.hasOwnProperty.call(n, t)
  }
  ,
  s.prototype.subscribers = function() {
      var t = {};
      return e(this._pubsub_topics, function(n, e) {
          t[e] = n.slice(0)
      }),
      t
  }
  ,
  s.prototype.subscribersByTopic = function(t) {
      return this._pubsub_topics[t] ? this._pubsub_topics[t].slice(0) : []
  }
  ,
  s.prototype.alias = function(t) {
      return e(t, function(n, e) {
          s.prototype[e] && (s.prototype[t[e]] = u(e))
      }),
      this
  }
  ,
...
!function(n, e) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : n.updwn = e()
}(this, function() {
  var n = null
    , e = null
    , t = u()
  ...
  function f(n) {
      requestAnimationFrame(function() {
          for (var e = u(), t = e.x, f = e.y, d = 0; d < o.length; d++)
              o[d]({
                  y: f,
                  prevY: r,
                  x: t,
  ...
  return function(t) {
      ...
      var r = t.interval;
      void 0 === r && (r = 100);
      var u, d = null, p = 0, a = 0, s = [], l = [];
      return u = function(n, e) {
          var t = n.y
            , o = n.prevY;
          p = e.timeStamp - a,
          a = e.timeStamp;
          var u = (Math.abs(t - o) / p || 0) * r > i;
          if (t >= o && "down" !== d && u) {
              d = "down";
      ...
      ,
      n || window.addEventListener("scroll", f),
      e || window.addEventListener("resize", f),
      o.indexOf(u) < 0 && o.push(u),
      {
          up: function(n) {
              return s.indexOf(n) < 0 && s.push(n),
              function() {
                  return s.splice(s.indexOf(n), 1)
              }
          },
          down: function(n) {
              return l.indexOf(n) < 0 && l.push(n),
              function() {
                  return l.splice(l.indexOf(n), 1)
              }
          },
          get position() {
              return d
  ...
  if ("undefined" != typeof window) {
      ...
      var i = function(t) {
        ...
        , o = function(t, e, i) {
          ...
          return n === l || o === l ? void (e.style[l] = "0") : n === a || o === a ? void (e.style[a] = "0") : "center" === n || "50%" === n ? (e.style[l] = "50%",
          void (e.style["margin-" + l] = d / -2 + "px")) : n.indexOf("%") >= 0 ? (n = parseInt(n),
          void (n < 50 ? (e.style[l] = n + "%",
          e.style["margin-" + l] = d * (n / -100) + "px") : (n = 100 - n,
          e.style[a] = n + "%",
          e.style["margin-" + a] = d * (n / -100) + "px"))) : void (e.style[l] = n)
      }
        , l = function(t) {
          ...
          t.style.height = "100%",
          t.style.width = "auto",
          "scale-down" === e && (t.style.height = "auto",
          t.clientWidth < a.clientWidth && t.clientHeight < a.clientHeight ? (o("x", t, l),
          o("y", t, l)) : (e = "contain",
          t.style.height = "100%")),
          "none" === e ? (t.style.width = "auto",
          t.style.height = "auto",
          o("x", t, l),
          o("y", t, l)) : "cover" === e && t.clientWidth > a.clientWidth || "contain" === e && t.clientWidth < a.clientWidth ? (t.style.top = "0",
          t.style.marginTop = "0",
          o("x", t, l)) : "scale-down" !== e && (t.style.width = "100%",
          t.style.height = "auto",
          t.style.left = "0",
...
jQuery(document).ready(function($) {
  ...
  if ($menu_current_item.length) {
      $menu_current_item.parents('.sub-menu, .children').slideToggle().parents('.menu-item-has-children, .cat-parent').toggleClass('jupiterx-icon-plus jupiterx-icon-minus')
  }
  $(document).on('click', '.jupiterx-widget .menu-item-has-children, .jupiterx-widget .cat-parent', function(e) {
      ...
      $(this).toggleClass('jupiterx-icon-plus jupiterx-icon-minus').find('> ul').slideToggle()
  });
});
jQuery(document).ready(function($) {
  $('.jupiterx-footer-fixed').each(function(index, element) {
      var footer = $(element), spacer
      spacer = $('<span></span>', {
...
jQuery(document).ready(function($) {
  ...
  ProductGallery.prototype.repositionDirectionNav = function() {
      var $gallery = this.$target, positionNav;
      if (!$gallery.hasClass('jupiterx-product-gallery-vertical')) {
          return;
      }
  ...
  function VariableProduct($variationsForm) {
      ...
      if (typeof VariableProduct._initialized == 'undefined') {
          ...
          VariableProduct.prototype.isVariationOnSale = function(variationId) {
              for (var i = 0; i < this.variations.length; i++) {
                  var variation = this.variations[i]
                  if (variation.display_price !== variation.display_regular_price && variationId === variation.variation_id) {
                      return true;
                  }
              }
              return false;
