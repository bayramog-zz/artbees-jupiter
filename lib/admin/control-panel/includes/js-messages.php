...
function jupiterx_adminpanel_textdomain() {
	return array(
		...
		'any_customisation_you_have_made_to_theme_files_will_be_lost'      => __( 'Any customisation you have made to theme files will be lost.', 'jupiterx-lite' ),
		...
		'wait_for_plugin_install'                                          => __( 'Please wait while the plugin going to be installed...', 'jupiterx-lite' ),
		...
		'deactivating_notice'                                              => __( 'Deactivating Notice', 'jupiterx-lite' ),
		'plugin_deactivate_successfully'                                   => __( 'Plugin deactivated successfully', 'jupiterx-lite' ),
		...
		'wait_for_plugin_delete'                                           => __( 'Please wait while the plugin going to be deleted...', 'jupiterx-lite' ),
		...
		'apikey_domain_match_error'                                        => __( 'Api key and domain is not matching', 'jupiterx-lite' ),
