...
<div class="jupiterx-cp-pane-box" id="jupiterx-cp-comparison">
	<table class="jupiterx-comparison-table">
		...
		<tr>
			...
			<td><?php esc_html_e( '240+ templates', 'jupiterx-lite' ); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="jupiterx-ct-text-center jupiterx-ct-bg-normal">
				...
				<a href="https://help.artbees.net/getting-started/jupiter-x-pro" target="_blank" class="jupiterx-ct-learn-more"><?php esc_html_e( 'Learn more about Jupiter X Pro', 'jupiterx-lite' ); ?></a>
			</td>
		</tr>
	</table>
</div>
