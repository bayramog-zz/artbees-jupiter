...
function jupiterx_activation_popup() {
	...
	wp_localize_script( 'jupiterx-activation-popup', 'jupiterx_activation_popup', [
		'important_note'                     => __( 'Important Note', 'jupiterx-lite' ),
		'jupiter_usage_title'                => __( 'It looks like you used Jupiter before.', 'jupiterx-lite' ),
		'jupiter_usage_message'              => __( 'We will support and update Jupiter as before, so you can keep using it safely. But in case you want to upgrade from Jupiter to Jupiter X please keep in mind that some re-adjustments or content recreation might be required.', 'jupiterx-lite' ),
		'learn_more'                         => __( 'Learn More', 'jupiterx-lite' ),
		'learn_more_link_title'              => __( 'Upgrading Jupiter Theme to Version X', 'jupiterx-lite' ),
		'activate_jupiter'                   => __( 'Activate Jupiter', 'jupiterx-lite' ),
		'activate_jupiter_message'           => __( 'This will deactivate Jupiter X theme and activate the Jupiter theme which is already installed. Are you sure you want to do it?', 'jupiterx-lite' ),
		'install_activate_jupiter'           => __( 'Install and activate Jupiter ', 'jupiterx-lite' ),
		'install_activate_jupiter_message_1' => __( 'Unzip the ThemeForest Downloaded package and locate Jupiter folder. <strong>jupiter-main-package > jupiter</strong>', 'jupiterx-lite' ),
		'install_activate_jupiter_message_2' => __( 'Upload Jupiter zip file and activate: <strong>Dashboard > Appearance  > Themes</strong>', 'jupiterx-lite' ),
		// Buttons.
		'take_me_back'                       => __( 'Take me back to Jupiter', 'jupiterx-lite' ),
		'fresh_start'                        => __( 'Fresh start with Jupiter X', 'jupiterx-lite' ),
		'done'                               => __( 'Done', 'jupiterx-lite' ),
		'discard'                            => __( 'Discard', 'jupiterx-lite' ),
		'activate_jupiter_btn'               => __( 'Activate Jupiter 6', 'jupiterx-lite' ),
